...
BEGIN
  ...
  VALUES 
    ...
    (v_group_id, v_lesson2_id, 
     ...
     '2026-01-10 07:00:00+00'::timestamptz,
    ...
    (v_group_id, v_lesson4_id, 
     ...
     '2026-01-17 07:00:00+00'::timestamptz,
    ...
    (v_group_id, NULL, 
     'UX/UI paskaita', 
     NULL,
     '2026-01-24 07:00:00+00'::timestamptz,
    ...
    (v_group_id, NULL, 
     'UX/UI paskaita', 
     NULL,
     '2026-01-31 07:00:00+00'::timestamptz,
    ...
    (v_group_id, NULL, 
     'UX/UI paskaita', 
     NULL,
     '2026-02-07 07:00:00+00'::timestamptz,
    ...
    (v_group_id, NULL, 
     'UX/UI paskaita', 
     NULL,
     '2026-02-14 07:00:00+00'::timestamptz,
    ...
    (v_group_id, NULL, 
     'UX/UI paskaita', 
     NULL,
     '2026-02-21 07:00:00+00'::timestamptz,
    ...
    (v_group_id, NULL, 
     'UX/UI paskaita', 
     NULL,
     '2026-02-28 07:00:00+00'::timestamptz,
    ...
    (v_group_id, NULL, 
     'UX/UI paskaita', 
     NULL,
     '2026-03-07 07:00:00+00'::timestamptz,
    ...
    (v_group_id, NULL, 
     'UX/UI paskaita', 
     NULL,
     '2026-03-21 07:00:00+00'::timestamptz,
    ...
    (v_group_id, NULL, 
     'UX/UI paskaita', 
     NULL,
     '2026-03-28 07:00:00+00'::timestamptz,
